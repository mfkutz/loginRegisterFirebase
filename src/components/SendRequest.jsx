        ...
        if (isValid) {
            ...
            try {
                ...
                await runTransaction(db, async (transaction) => {
                    ...
                    // Almacenar el ID de la transferencia en la variable o estado
                    setTransferId(transfer.id);
                    setDateCompleted(transfer.date);
    ...
    return (
        <div className="relative">
            ...
            <div className={`ml-[14%] h-[90vh] bg-gray-900 text-gray-300 px-40 ${fundSent ? '' : 'hidden'}`}>
                ...
                <div className="flex justify-center text-[20px] font-bold mt-9 mb-4">{transferPurpose}</div>
